...
const CATEGORIES = ["All Categories", "Surgery", "Pediatrics", "Cardiology", "Neurology", "Radiology", "Emergency Medicine", "Internal Medicine", "Orthopedics"];
...
export default function CourseBrowser({ initialCourses, purchasedCourseIds = [] }: CourseBrowserProps) {
    ...
    }, [initialCourses, searchQuery, selectedLevel, selectedCategory, selectedLanguage]);
    ...
    return (
        <div className="w-full animate-in fade-in slide-in-from-bottom-4 duration-700">
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm border border-slate-100 mb-10 space-y-6">
                ...
                {/* Category Filter */}
                <div className="space-y-3">
                    <label className="text-sm font-bold text-blue-900 uppercase tracking-wide">Choose Category:</label>
                    <div className="flex flex-wrap gap-2">
            ...
            <div className="flex items-center justify-between mb-8 bg-blue-50/50 p-4 rounded-lg border border-blue-100 text-blue-800">
                <span className="font-semibold text-lg">
                    <span className="font-bold text-2xl mr-1">{filteredCourses.length}</span> courses found
                </span>
            </div>
